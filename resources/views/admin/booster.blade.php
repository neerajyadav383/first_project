...
@section('content')
@section('meta_title', 'BOOSTER INCOME')
@section('meta_keyword', 'BOOSTER INCOME')
@section('meta_description', 'BOOSTER INCOME')
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    @php $i=1; @endphp
                                    @foreach($boosterIncomeReport as $incomeReports)
                                    <tr>
                                        <td>{{ $i }}</td>
