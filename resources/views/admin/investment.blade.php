...
@section('content')
@section('meta_title','Investment')
@section('meta_keyword','Investment')
@section('meta_description','Investment')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form action=" {{ url('add_investment') }} " method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="datatable table table-stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $walletRequest->user_details['userid'] ?? $walletRequest->user_id }} ( {{ $walletRequest->user_details['name'] ?? '' }} )</td>
...
<script>
    function reject(id) {
        ...
        var url = "<?php echo e(url('reject_investment')); ?>";
    ...
    function approve(id) {
        ...
        var url = "<?php echo e(url('approve_investment')); ?>";
        $.ajax({
            url: url,
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
